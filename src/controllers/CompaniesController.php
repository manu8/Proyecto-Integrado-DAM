...
})->bind('companies_list')->value('page', 1);
...
})->bind('companies_category_list')->value('page', 1);
...
})->bind('company_add_categories')->value('page', 1);
...
})->bind('add_students')->value('page', 1);
...
})->bind('add_study_students')->value('page', 1);
